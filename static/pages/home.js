export const homeContent = {
  ...
  <li>
    <p dir="auto">
      Bundle the project and upload it on my server
    </p>
  </li>
  <li>
    <p dir="auto">
      Resume work on planet-generator and galactic-explorer
    </p>
  </li>
  </ul>
  </div>`,
...
export const buttonTranslations = {
  aboutFr: "<h3>À propos</h3>",
  aboutEn: "<h3>About</h3>",
  blog: "<h3>Blog</h3>",
  projectsFr: "<h3>Projets</h3>",
  projectsEn: "<h3>Projects</h3>",
};

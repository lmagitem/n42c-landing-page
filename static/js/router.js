...
export const redirectFromOldBlog = () => {
    ...
    if (pathMatch && pathMatch[4] !== undefined) {
        const path = pathMatch[4].trim().endsWith("/") ?
            pathMatch[4].trim().slice(0, -1) :
            pathMatch[4];
